    ...
    variant: [
      {
        ...
        title: 'CHULA Day',
        detail:
          'กระเป๋าผ้าแคนวาส CHULA Day ขนาด 14*16 นิ้ว ไอเทมสุดน่ารักเสริมโชคและกำลังใจในการสอบ',
      ...
      },
      {
        ...
        detail:
          'ไอเทมลับเด็กเตรียมสอบ! กระเป๋า Carry-All Chula Edition เนื้อผ้าแคนวาส ขนาด 14*16 นิ้ว จุชีทติวได้เพียบ สะพายรับพลังจามจุรี มูให้สุดแล้วไปหยุดที่สอบติด',
    ...
    variant: [
      {
        ...
        title: 'I Have Item',
        detail:
          'กำไลเชือกเทียนถักมือสุดประณีต ของที่ระลึกสุดคิวท์จาก CU Open House 2026 ปรับขนาดได้ตั้งแต่ 16-30 ซม. (อาจคลาดเคลื่อนเล็กน้อยเพราะเป็นงานแฮนด์เมด) สินค้ามีหลายแบบให้เลือกนอกเหนือจากในภาพ มาเลือกแมทช์ความน่ารักในสไตล์ของคุณกลับบ้านกันเลย!',
