...
const QuestionaireStep1 = ({
  ...
  const setRating = (key: 'q1' | 'q2' | 'q3' | 'q5', value: number) => {
    setFormData({
      ...formData,
      part1: {
        ...formData.part1,
  ...
  return (
    <div className="flex h-fit w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <p className="font-semibold">
          4. {t('routes.questionaireGroup.part1.q4.question')}
        </p>
        <Input
          placeholder={t('routes.questionaireGroup.part1.q4.placeholder')}
          className="border-main-pink text-main-pink placeholder:text-main-light-pink"
          value={formData.part1.q4}
          onChange={(e) =>
            setFormData({
              ...formData,
              part1: {
      ...
      {/* Q5: Rating */}
      {(['q5'] as const).map((key, index) => (
        <>
          <div key={key} className="flex flex-col gap-2">
            <p className="font-semibold">
              {index + 5}. {t(`routes.questionaireGroup.part1.${key}.question`)}{' '}
              <RedStar />
            </p>
