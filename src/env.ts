...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    VITE_PUBLIC_GOOGLE_PROJECT_ID: import.meta.env.VITE_PUBLIC_GOOGLE_PROJECT_ID,
    ...
    VITE_PUBLIC_GOOGLE_AUTH_PROVIDER_X509_CERT_URL: import.meta.env.VITE_PUBLIC_GOOGLE_AUTH_PROVIDER_X509_CERT_URL,
  },
